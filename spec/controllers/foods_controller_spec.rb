...
RSpec.describe FoodsController, type: :controller do
  ...
  let(:invalid_attributes) {
    FactoryGirl.attributes_for(:food, name: nil)
  }
  ...
  describe "GET #index" do
    ...
    context "with food_type = drinks" do
      it "assigns only drinks as @foods" do
        get :index, {food_type: 'drinks'}, valid_session
        expect(assigns(:foods)).to eq([@drink])
      end
    end
  end
